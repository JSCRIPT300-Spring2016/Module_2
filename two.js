...
var myDate = (function iife() {
    ...
    //
    function checkDate() {
        if (imaDate === undefined || imaDate === null) {
            imaDate = new Date();
        }
    ...
    function getDate(option) {
        ...
        {
            return "[" + imaDate.getMonth() + "][" + imaDate.getDate() + "], ["
                    + imaDate.getFullYear() + "]";
        }
    ...
    function isToday() {
        ...
        return (imaDate.getDay() === timeNow.getDay())
               && (Math.abs(imaDate.getTime() - timeNow.getTime()) <= millisInDay);
    }
