...
var myDate = (function iife() { 
   ...
   // you'll want to make sure you've instantiated it first. Your module should not start out
   // with this date being set to anything yet. If it hasn't yet been instantiated, instantiate
   // it then (this is a good place to use a "private" method.) If it has already been instantiated,
   // don't re-instantiate it (with the exception of setDate which should instantiate your date
   // again based on how it's called (see sample usage below.)
   //
   function checkDate() { 
      if (imaDate === undefined || null) 
      {
         imaDate = new Date();
      }
   } 
   ...
   function setDate(date) { 
      ...
      { 
          imaDate = new Date(date); 
      } 
      else if (date instanceof Date) { 
          imaDate = new Date(date.getTime()); 
      }
      else 
      {
          imaDate = new Date();
   ...
   function getDate(option) { 
      ...
      { 
          return imaDate.getTime(); 
      } 
      else if (option.format === "formatted") 
      { 
          return "[" + imaDate.getMonth() + "][" + imaDate.getDate() + "], [" + imaDate.getFullYear() + "]"; 
      } 
   ...
   // in the "future" based on when this method is called. This method takes no parameter. Sample usage: 
   //
   // console.log(myDate.isFuture()); // false 
   //
   function isFuture() { 
      checkDate();
      return imaDate.getTime() > Date.now();
   } 
 

   // name: isToday
   //
   // purpose: returns a boolean true or false, based on whether the internally stored date is "today"
   // based on when this method is called. Note that this means the internally stored date can be in 
   // the future or the past relative to when this method is called. Think carefully about how you 
   // determine if something is "today". Sample usage: 
   //
   ...
   function isToday() { 
      ...
      checkDate();
      return imaDate.getDay() === timeNow.getDay() && Math.abs(imaDate.getTime() - timeNow.getTime()) <= millisInDay;
   } 
 ...
 console.log(myDate.getDayName());  
 console.log(myDate.getMonthName());  

 myDate.setDate();
 console.log(myDate.getDate());  
 myDate.setDate(null);
 console.log(myDate.getDate());  
 myDate.setDate(1234567890);
 console.log(myDate.getDate());  
 myDate.setDate(-1234567890);
 console.log(myDate.getDate());  
 myDate.setDate(new Date());
 ...
 console.log(myDate.getDate({ format: "milliseconds" })); 
 console.log(myDate.getDate({ format: "formatted" })); 
 console.log(myDate.getDate());  
 console.log(myDate.getDate("Fred"));

 console.log(myDate.getDayName());  
 console.log(myDate.getMonthName());  

 myDate.setDate(new Date().getTime() - 10);
 ...
 myDate.setDate(new Date().getTime() + 43200000);
 console.log(myDate.isToday());
 console.log(myDate.isFuture());

 myDate.setDate(new Date().getTime() + 86400000);
 console.log(myDate.isToday());
 console.log(myDate.isFuture());
